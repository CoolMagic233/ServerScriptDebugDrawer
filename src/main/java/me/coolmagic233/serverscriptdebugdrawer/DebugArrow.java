...
public class DebugArrow extends DebugShape {
     ...
     */
    public DebugArrow(Vector3f position, Color color, Vector3f endPosition, Float arrowHeadLength, Float arrowHeadRadius, Integer arrowHeadSegments, Float arrowHeadScale) {
    ...
    public CloudBrustDebugShape.Type getType() {
        return CloudBrustDebugShape.Type.ARROW;
    }

    @Override
    public CloudBrustDebugShape toNetworkData() {
        return new CloudBrustDebugShape(
                id, getType(), position, arrowHeadScale,
                null, null, color,
